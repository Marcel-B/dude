...
namespace com.b_velop.IdentityCat.Service.Pages.Account.Create;
...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        var userExists = await _userStore.FindByUsername(Input.Username);
        if (userExists != null)
        {
        ...
        if (ModelState.IsValid)
        {
            var user = await _userStore
                .CreateUser(Input.Username, Input.Password, Input.Email, Input.Name, Input.GivenName);
