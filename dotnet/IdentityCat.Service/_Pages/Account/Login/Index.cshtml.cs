...
public class Index : PageModel
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (await _userStore.ValidateCredentials(Input.Username, Input.Password, cancellationToken))
            {
                var user = await _userStore.FindByUsername(Input.Username, cancellationToken);
