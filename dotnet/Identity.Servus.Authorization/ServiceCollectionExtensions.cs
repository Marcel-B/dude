...
{
    public static IServiceCollection AddAuthZ(
...
// Register the OpenIddict services.
        serviceCollection
            ...
            .AddServer(options =>
            {
                ...
                options.RegisterClaims(configuration
                    .GetSection("OpenIddict:Claims")
                    .Get<string[]>());

                // Expose all the supported scopes in the discovery document.
                options.RegisterScopes(configuration
                    .GetSection("OpenIddict:Scopes")
                    .Get<string[]>());
