    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Measurements_Timestamps_TimestampId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f5dcc688-e60a-421d-ae44-ac527f7bfba7"), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "TEMP", "°C", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Measurements_TimestampId",
                table: "Measurements",
                column: "TimestampId");
